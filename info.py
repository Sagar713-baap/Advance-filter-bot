...
# Bot information
SESSION = environ.get('SESSION', 'Moviesearchbot')
API_ID = int(environ.get('API_ID', '14296467'))
API_HASH = environ.get('API_HASH', 'a61d6246cb937abc1640aee0ec41fba3')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://videoasmr63:kXBNVFKQ0NegxJvS@cluster0.bte2mba.mongodb.net/")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'sagar713') # owner username without @
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/aaaasssddddfjh')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Secret_movie_hub')
